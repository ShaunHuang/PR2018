...
%Phase
zerVec=lambda*[0, 0, 0, 1,...
               0, 0, -1, 0.5];%The parameter is corresponding to the parameter of Zemax (Fringe Zernike Phase)
HalfDim = EffDim/2;
NormRadius = HalfDim;
...
% z_prop=[236,252,284,308];
z_prop=[200,250,265,290];
...
% z_prop=z_prop+(rand(1,imgNum))*3;%Z shift error
% z_prop=z_prop+3;%Z shift error
...
%     FocalPhase_Init = exp(1j*k*FocalSag_Init);
    ...
    zerVec_Init=lambda*[0, 0, 0, 1,...
                   0, 0, -1, 0.4];%The parameter is corresponding to the parameter of Zemax (Fringe Zernike Phase)
